...
for  %%s in (*.lua) do ( 
echo %%s
copy %conf_path_http%script\%%s %path_web_script%%%s
) 

cd %conf_path_http%script\formation\
for  %%s in (*.lua) do ( 
echo %%s
copy %conf_path_http%script\formation\%%s %path_web_script%formation\%%s
) 

cd %conf_path_http%script\resBattle\
for  %%s in (*.lua) do ( 
echo %%s
copy %conf_path_http%script\resBattle\%%s %path_web_script%resBattle\%%s
) 
copy 
